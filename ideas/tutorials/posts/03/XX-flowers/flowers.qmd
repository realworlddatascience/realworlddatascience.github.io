...
We use the `R` programming language. In particular, our code relies on the following packages:
...
He communicated this law in his *Letters addressed to HRH the grand duke of Saxe-Coburg and Gotha* [Number 33, -@quetelet1846lettres; translated -@quetelet_1849] and in his reporting *On the climate of Belgium* [Chapter 4, Part 4, -@observatoire1834annales; data updated in Part 7, -@quetelet_1857]. A picture of Quetelet and the title page of On the climate of Belgium (1857) are displayed in Figure 1.

:::{layout-ncol=2}
![](images/quetelet_1875400.jpg){description="Adolphe Quetelet. Source: [Wikipedia](https://en.wikipedia.org/wiki/Adolphe_Quetelet#/media/File:Adolphe_Qu%C3%A9telet_by_Joseph-Arnold_Demannez.jpg)" height=400px group="Quetelet"}

![](images/sur_le_climat400.jpeg){description="Title page of *On the climate of Belgium.* Source: [Gallica](https://gallica.bnf.fr/ark:/12148/bpt6k95028d)" height=400px group="Quetelet"}
:::

:::{.figure-caption}
**Figure 1:** Quetelet reported on the law of the flowering plants in *On the climate of Belgium* (1857). Source: [Wikipedia](https://en.wikipedia.org/wiki/Adolphe_Quetelet#/media/File:Adolphe_Qu%C3%A9telet_by_Joseph-Arnold_Demannez.jpg), [Gallica](https://gallica.bnf.fr/ark:/12148/bpt6k95028d)
:::
...
![](images/quetelet_bloom.png){width="600" fig-align="center" description="Bloom dates at Brussels Observatory observed by Quetelet between 1839 and 1852. Source: [Gallica](https://gallica.bnf.fr/ark:/12148/bpt6k95028d)"}
...
To reproduce Quetelet's law, we combine the data in Figure 2 with additional observations from his *Letters*. We focus on Quetelet's primary example, the bloom date of the common lilac, *Syringa vulgaris*, row 18 of Figure 2. We do this because Quetelet carefully describes his methodology for measuring the bloom date of lilacs. For example, Quetlelet considers a lilac to have bloomed when "the first corolla opens and shows the stamina." That event is closest to what the USA Phenology Network describes as "open flowers", depicted in the center image of Figure 3 below. This detail will become relevant when we attempt to replicate Quetelet's law in a later section. Note that although we focus on lilacs in this tutorial, the `R` code is easily edited to predict the day that other plants will bloom.

:::{layout-ncol=3}
![](images/buds250.jpg){height=250px group="flowers" description="Flower buds. Source: [USA National Phenology Network](https://www.usanpn.org/nn/TrackaLilac)"}

![](images/open_flowers250.jpg){height=250px group="flowers" description="Open flowers. Source: [USA National Phenology Network](https://www.usanpn.org/nn/TrackaLilac)"}

![](images/full_flowers250.jpg){height=250px group="flowers" description="Full flowers. Source: [USA National Phenology Network](https://www.usanpn.org/nn/TrackaLilac)"}
:::
...
## Deriving Quetelet's law of the flowering plants
...
![](images/fig5.png){description="**Figure 5:** Predictions using Quetelet's law are accurate within about two weeks on average."}

:::{.figure-caption}
**Figure 5:** Predictions using Quetelet's law are accurate within about two weeks on average.
:::
...
We visualize the predictions in Figure 7, which has the same interpretation as Figure 4. If the temperature forecast and Quetelet's law are correct, on January 27, 2023 the lilacs in Brussels began "collecting" temperature. The lilacs will continue to "collect" temperature until April 19, at which point they will exceed their 4264°C² quota and bloom.
...
(temp_br %>% 
  ...
  labs(
    ...
    y = "midrange temperature (°C)",
    title =
      "Figure 7: According to Quetelet's law, the lilacs will bloom once exposed to 4264°C² following the last frost.") +
...
![](images/fig7.png){description="**Figure 7:** According to Quetelet's law, the lilacs will bloom once exposed to 4264°C² following the last frost."}
...
Although Quetelet did not discover the law, he did much to advance it. Queletet founded an international network for "observations of the periodical phenomena" (in addition to numerous statistical societies and publications, including the precursor to the Royal Statistical Society). Quetelet’s network of eighty stations collected observations throughout Europe from 1841 until 1872. In particular, Quetelet collaborated with Charles Morren -- who later coined the term phenology, the name of the field that now studies biological life-cycle events like the timing of flower blooms [@demarée_rutishauser_2011].

In recent years, the observations collected through phenology networks have become an important resource for understanding the impacts of climate change. For example, the USA National Phenology Network calculates the Spring Bloom Index, which measures the "first day of spring" using the days lilacs are observed to bloom at locations across the United States. The index is then compared to previous years. Figure 8 shows one comparison, called the Return Interval. The Return Interval is much like a p-value, calculating how frequently more extreme spring indices were observed in previous decades. Bloom dates that are uncommonly early (green) or late (purple) may indicate environments stressed by changing climate. Scientists exploit the relationship between temperature and bloom date to extrapolate the index to areas with few observations.

![](images/six-bloom-return-interval-2020.png){description="**Figure 8:** The Spring Bloom Index Return Interval measures whether spring is typical when compared to recent decades. Source: [USA National Phenology Network](https://www.usanpn.org/files/npn/maps/six-bloom-return-interval-2020.png)"}

:::{.figure-caption}
**Figure 8:** The Spring Bloom Index Return Interval measures whether spring is typical when compared to recent decades. Source: [USA National Phenology Network](https://www.usanpn.org/files/npn/maps/six-bloom-return-interval-2020.png)
:::
...
::: {.g-col-12 .g-col-md-6}
How to cite
: Auerbach, Jonathan. 2023. "A demonstration of the law of the flowering plants." Real World Data Science, March 9, 2023. [URL](https://realworlddatascience.net/ideas/tutorials/posts/03/XX-flowers/flowers.html)
:::
:::
:::