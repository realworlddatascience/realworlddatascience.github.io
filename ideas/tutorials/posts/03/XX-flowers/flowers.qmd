...
![](images/quetelet_bloom.png){width="600" fig-align="left" description="Bloom dates at Brussels Observatory observed by Quetelet between 1839 and 1852. Source: [Gallica](https://gallica.bnf.fr/ark:/12148/bpt6k95028d)"}
...
![](images/fig6.png){description="**Figure 6:** According to Quetelet's law, the lilacs will bloom once exposed to 4264°C² following the last frost."}
...
![](images/six-bloom-return-interval-2020.png){description="**Figure 7:** The Spring Bloom Index Return Interval measures whether spring is typical when compared to recent decades. Source: [USA National Phenology Network](https://www.usanpn.org/files/npn/maps/six-bloom-return-interval-2020.png)"}
...
::: {.g-col-12 .g-col-md-6}
How to cite
: Auerbach, Jonathan. 2023. "A demonstration of the law of the flowering plants." Real World Data Science, March XX, 2023. [URL](https://realworlddatascience.net/ideas/tutorials/posts/03/XX-flowers/flowers.html)
:::
:::
:::