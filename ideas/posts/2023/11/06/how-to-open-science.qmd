...
![](images/pre-registration.png){fig-alt="Screengrab of a pre-registration document, detailing a research project's hypothesis, study type, and study design."}
:::
...
![](images/osf.png){width="80%" fig-align="center" fig-alt="Screengrab of an Open Science Framework repository for a project titled 'Why "one size fits all" is not enough when designing COVID-19 immunity certificates for domestic use: a UK wide cross-sectional online survey.'"}
