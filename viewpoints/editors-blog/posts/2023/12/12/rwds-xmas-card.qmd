...
If you missed the Meetup session, Nicola has kindly written [a tutorial for Real World Data Science](/ideas/tutorials/posts/2023/12/12/xmas-cards.qmd) that walks through all the necessary steps to create a snowman against a snowy night's sky. You'll want to read that tutorial first before returning to this blog.
