...
description: |
  At the Royal Statistical Society (RSS) Conference this September, Real World Data Science brought together data scientists, statisticians, and policy experts to discuss the urgent topic of artificial intelligence -- risks, benefits, evaluation, and regulation. Watch the panel discussion in full!
categories:
  - AI
...
::: {.g-col-12 .g-col-md-6}
How to cite
: Tarran, Brian. 2023. "How data science and statistics can shape the UK's AI strategy." Real World Data Science, October 30, 2023. [URL](https://realworlddatascience.net/viewpoints/editors-blog/posts/2023/10/30/ai-conf-panel.html)
:::
:::
:::