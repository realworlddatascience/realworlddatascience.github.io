...
description: |
  We sit down with the Royal Statistical Society’s Data Science & AI section to hear how large language models are becoming part of the data science toolkit – and what this new development means for data science teams and skillsets.        
categories:
...
Data scientists certainly have been thinking along these lines, and to find out more about current use cases, proofs of concepts and potential applications, Real World Data Science got together with members of the [Royal Statistical Society’s Data Science & AI section](https://rss.org.uk/membership/rss-groups-and-committees/sections/data-science-section/) (DS&AI) for a group discussion.
...
This feels like a brand-new capability -- an interface with unstructured information. Historically, you have to turn text into something, and then turn something back into text, if you want to have this interface with humans. Now, we’ve got this really quite elegant way of plugging the gaps.  
:::
:::
:::
...
Part two of our conversation with the Royal Statistical Society's Data Science & AI section will be published soon. Stay tuned!
:::
...
:   Tarran, Brian. 2023. "How is ChatGPT changing data science?" Real World Data Science, May 11, 2023. [URL](https://realworlddatascience.net/viewpoints/interviews/posts/2023/05/11/chatgpt-data-science-pt1.html)
:::
:::
:::