...
Now, it is over to you. Our [Jupyter notebook](http://c100-159.cloud.gwdg.de:9009/lab/tree/notebooks/main.ipynb) provides a walkthrough of our research. Our [GitHub repository](https://github.com/dsvanidze/replicability/tree/master) has all the data, code and other files you need to reproduce our work, and this [README file](https://github.com/dsvanidze/replicability/blob/master/README.md) will help you get started.
