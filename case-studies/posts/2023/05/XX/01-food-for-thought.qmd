...
This special collection of articles tells the story of the Food for Thought Challenge. We begin by exploring the [policy issues](link) that drive the development of the PPC – the need to understand the national diet, developing healthy diet plans, and costing up those plans – and the issues posed by record linkage. Next, we learn about [the nature of the challenge and the structure of the competition in more detail](link), and then the [three](link) [winning](link) [teams](link) walk us through their solutions. We end the collection with some closing thoughts on [the value of competitions for addressing data scientific challenges in the public sector](link).
...
::: {.g-col-12 .g-col-md-6}
::: article-btn
[Part 1: The Purchase to Plate Suite &rarr;](/case-studies/posts/2023/05/XX/02-policy-and-research.qmd)
:::
:::
:::
