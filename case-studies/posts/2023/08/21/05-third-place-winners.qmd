...
Find the code in the [Real World Data Science GitHub repository](link).
:::
...
::: {.g-col-12 .g-col-md-6}
How to cite
: Hu, Yifan, and Mandy Korpusik. 2023. "Food for Thought: Third place winners -- Binary classification with pre-trained BERT." Real World Data Science, August 21, 2023. [URL](https://realworlddatascience.net/viewpoints/case-studies/posts/2023/08/21/05-third-place-winners.html)
:::
:::
:::