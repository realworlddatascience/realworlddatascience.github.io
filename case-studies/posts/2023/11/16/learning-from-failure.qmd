...
![](images/jcos-recording-totals-across-dorms.png)
...
::: {layout-nrow="2"}
![**Number of clips** = Number of clips recorded.](images/film.png)

![**Days with footage** = Number of discrete dates that appear in these clips.](images/calendar.png)

![**Footage hours** = Total duration of all shot footage.](images/clock.png)

![**Significant gaps** = Number of clips where the previous clip's end date was either greater than 15 minutes or less than eight hours before current clip's start date.](images/caution.png)
:::

I used these aggregations to devise the following **staff metrics**:

::: {layout-nrow="2"}
![**Clips per day** = Number of clips / Days with footage.](images/clip-per-day.png){width="300px"}

![**Footage per day** = Footage hours / Days with footage.](images/footage-per-day.png){width="300px"}

![**Average clip length** = Footage hours / Number of clips.](images/avg-clip-length.png){width="300px"}

![**Gaps per day** = Gaps / Days with footage.](images/gaps-per-day.png){width="300px"}
:::
