...
description: |
  Robin Linacre introduces a tool developed by the UK Ministry of Justice, which uses probabilistic record linkage to improve the quality of justice system data.
categories:
  - Crime and justice
  - Data quality
  - Data linkage
