---
title: "Why Data Quality Is the New Competitive Edge For Data Scientists"
description: |
  Data scientists were in high demand when they were set apart as coding wizards who could wrangle insights from large amounts of data. In the age of AI, everyone can code and data scientists must pivot their skillset.
date: 2026-01-27
date-format: long
authors:
  - Roger Hoerl
...
As LLMs improve in their ability to quickly generate vast amounts of accurate code, what does that mean for a discipline which has prided itself on its data wrangling skills? As Davenport and Patil noted “data scientists’ most basic, universal skill is the ability to write code” [@davenport2012sexiest]. Data science has seen coding as a viable career path.
...
You can find out more about the *Real World Data Science* stance on data quality from our article ['Why We Should All Be Data Quality Detectives'](https://realworlddatascience.net/foundation-frontiers/posts/2025/10/30/data-detectives.html). 
