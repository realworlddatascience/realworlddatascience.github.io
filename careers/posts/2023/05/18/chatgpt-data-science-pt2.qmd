...
**To close us out, I’d like to return to [a question Trevor posed earlier](http://localhost:5404/careers/posts/2023/05/11/chatgpt-data-science-pt1.html), which is: How might organisations like the Royal Statistical Society help companies to embrace LLMs and start using them, so that everyone can benefit from the technology?** 
