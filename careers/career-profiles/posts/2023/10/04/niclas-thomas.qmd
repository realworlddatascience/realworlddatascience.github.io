...
description: |
  A passion for solving mathematical problems led Niclas Thomas to a PhD in machine learning and then a career in data science in the retail sphere. Now head of data science for Next, Thomas reflects on his career journey so far.
categories:
  - Leadership
  - Management
  - Communication
