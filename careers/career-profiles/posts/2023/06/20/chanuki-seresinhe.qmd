...
In data science, getting the model right is not enough, and working with people across the business to make sure the model can be integrated into the business processes is essential. If you do not use the time when developing your proof of concept to also make sure to get the right stakeholder on board, your project is dead before it even starts.
:::
:::
:::
...
::: {.g-col-12 .g-col-md-6}
How to cite
: Tarran, Brian. 2023. "'Once I started to see what was possible with data science, there was no going back'" Real World Data Science, June 20, 2023. [URL](https://realworlddatascience.net/careers/career-profiles/posts/04/24/sami-rahman.html)
:::
:::
:::