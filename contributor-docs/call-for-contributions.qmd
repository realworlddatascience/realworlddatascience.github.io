...
## Use of AI in Submissions 
High-quality data is the foundation of trustworthy research. Yet, data quality is often overlooked in academic submissions. We believe this needs to change.

To support a culture shift, we ask all contributors to:

* Conduct and document basic data quality checks before submission.
* Flag any known limitations or uncertainties in the dataset.
* Include a brief statement on how data quality was assessed and maintained.

By doing so, you help ensure that your findings are robust, reproducible, and valuable to the wider research community.
