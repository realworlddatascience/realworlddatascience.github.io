...
The figures below show the results graphically as proportions of (a) all tests and (b) all positive tests. (All plots are produced using Python and the `matplotlib` package; code and functions are available from [this GitHub repository](https://github.com/fatso-jetson/screening-tests).)
