...
**Editor's note:** This post is republished with permission from [MathStatBites](https://mathstatbites.org/determining-the-best-way-to-route-drivers-for-ridesharing-via-reinforcement-learning/) to demonstrate the Bites concept. See [here](ridesharing.qmd#about-datasciencebites) for more information.
:::
...
[![](/news-and-views/datasciencebites/datasciencebites-logo.png){fig-alt="DataScienceBites logo. A dark grey circle with bite marks cut out. Overlaid text says, Import grad_students as writers, import new_research_papers as nrp, print(writers + nrp) and the title DataScienceBites." width="200" fig-align="center"}](/news-and-views/datasciencebites/index.qmd)