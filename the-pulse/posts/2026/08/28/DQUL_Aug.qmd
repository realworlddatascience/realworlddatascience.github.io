...
description: |
  August's case of the month explores a high stakes question: whether we can trust medical tools built on publically available data-sets.  
categories:
  - data quality
  - Governance
  - Policy
...
Data provenance, the who, what, when, where, why and how of data is now more important than ever. Trust in the source and quality of data is imperative for developing predictions that aim to directly influence induvial health and be applied to populations. 
