---
title: "RSS AI Task Force says: AI Regulation Needs Statistics"
...
The Royal Statistical Society’s [AI Task Force](https://rss.org.uk/policy-campaigns/policy-groups/ai-task-force/) has issued a critical mandate via a new paper, [AI Regulation Needs Statistics](https://rss.org.uk/RSS/media/File-library/Policy/2026/Regulating-AI-1-1_1.pdf), which demands that statistical principles actively shape global AI governance.

The publication escalates the core argument of their foundational work, [AI is Statistics](https://rss.org.uk/RSS/media/File-library/Policy/2026/AI-is-Statistics-FINAL.pdf). This earlier paper argued that AI is fundamentally statistical, meaning effective and ethical deployment is impossible without statistical literacy. You can watch our expert panel discuss the topic [here](https://realworlddatascience.net/the-pulse/posts/2026/03/10/rwds_big_questions_ai_statistics.html). 
